	...
	<div id="myticketdiv">
		<form action="myticketservlet" method="post">
			<table id="ticketnotable">
				<tr>
					<th><label for="tickettext">TICKET NUMBER:</label></th>
					<th><input type="text" pattern="[A-Za-z0-9]{7}"
						title="please enter 7 digit ticket number" name="tickettext"
						placeholder="Enter the ticket number" id="tickettext" autofocus
