...
<style>
    ...
    <body>
    	...
    	<c:set var="update" scope="session" value="${param.updateBus}" />
       ...
       <ul>
        ...
        <div id="buslistdiv">
            ...
            <thead>
                ...
                <tbody>
                <c:forEach begin="0" items="${BusListAdmin}" var="bus" varStatus="loop">
                <tr>
                	<td>${loop.count }</td>
                    <td>${bus.getBusId() }</td>
                    <td>${bus.getBusNo() }</td>
                    ...
                    <td><button id="editbutton" onclick="editBus(${bus.getBusId()})">Edit</button></td>
                </tr>
                </c:forEach>
                </tbody>
            </table>
